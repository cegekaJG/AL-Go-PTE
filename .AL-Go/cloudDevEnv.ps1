...
$GitHubHelperUrl = 'https://raw.githubusercontent.com/cegekaJG/AL-Go-Actions/update-cleanup/Github-Helper.psm1'
...
$ALGoHelperUrl = 'https://raw.githubusercontent.com/cegekaJG/AL-Go-Actions/update-cleanup/AL-Go-Helper.ps1'
