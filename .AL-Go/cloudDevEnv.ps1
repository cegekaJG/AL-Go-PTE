...
$GitHubHelperPath = DownloadHelperFile -url 'https://raw.githubusercontent.com/cegekaJG/AL-Go-Actions/publish-testmaster/Github-Helper.psm1' -folder $tmpFolder
$ALGoHelperPath = DownloadHelperFile -url 'https://raw.githubusercontent.com/cegekaJG/AL-Go-Actions/publish-testmaster/AL-Go-Helper.ps1' -folder $tmpFolder
DownloadHelperFile -url 'https://raw.githubusercontent.com/cegekaJG/AL-Go-Actions/publish-testmaster/Packages.json' -folder $tmpFolder | Out-Null
