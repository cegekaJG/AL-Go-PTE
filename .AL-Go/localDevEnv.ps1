...
$GitHubHelperPath = DownloadHelperFile -url 'https://raw.githubusercontent.com/cegekaJG/AL-Go-Actions/cegeka6/Github-Helper.psm1' -folder $tmpFolder
$ALGoHelperPath = DownloadHelperFile -url 'https://raw.githubusercontent.com/cegekaJG/AL-Go-Actions/cegeka6/AL-Go-Helper.ps1' -folder $tmpFolder
DownloadHelperFile -url 'https://raw.githubusercontent.com/cegekaJG/AL-Go-Actions/cegeka6/Packages.json' -folder $tmpFolder | Out-Null
