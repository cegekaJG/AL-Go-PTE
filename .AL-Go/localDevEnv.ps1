...
$GitHubHelperPath = DownloadHelperFile -url 'https://raw.githubusercontent.com/cegekaJG/AL-Go-Actions/testbranch6fix/Github-Helper.psm1' -folder $tmpFolder
$ALGoHelperPath = DownloadHelperFile -url 'https://raw.githubusercontent.com/cegekaJG/AL-Go-Actions/testbranch6fix/AL-Go-Helper.ps1' -folder $tmpFolder
DownloadHelperFile -url 'https://raw.githubusercontent.com/cegekaJG/AL-Go-Actions/testbranch6fix/Packages.json' -folder $tmpFolder | Out-Null
