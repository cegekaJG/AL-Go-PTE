...
$GitHubHelperUrl = 'https://raw.githubusercontent.com/cegekaJG/AL-Go-Actions/cegeka/Github-Helper.psm1'
...
$ALGoHelperUrl = 'https://raw.githubusercontent.com/cegekaJG/AL-Go-Actions/cegeka/AL-Go-Helper.ps1'
